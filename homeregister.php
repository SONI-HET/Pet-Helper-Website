...
<body>
						...
						<div class="res-container">
							<ul class="nav navbar-nav">
								<li class="mega-menu-fullwidth">
									<a style=" color: white; background-color: #72c02c; text-decoration: underline; border-radius: 5px;" id="n1" href="homeregister.php">
										HOME
									</a>

								</li>
								<li class="mega-menu-fullwidth">
									<a id="n1" href="aboutreg.php">
										ABOUT US
									</a>
								</li>
								<!-- <li class="mega-menu-fullwidth">
								...
								<li class="mega-menu-fullwidth">
									<a id="n1" href="galreg.php">
										GALLERY
									</a>

								</li>
								<li class="mega-menu-fullwidth">
									<a id="n1" href="blogreg.php">
										BLOGS
									</a>
								</li>
								<li class="mega-menu-fullwidth">
									<a id="n1" href="contreg.php">
										CONTACT US
									</a>
								</li>
								<li class="mega-menu-fullwidth">
									<a id="n1" href="bookreg.php">
										BOOK APPOINTMENT
									</a>
								</li>
								<li class="mega-menu-fullwidth">
		...
		<div class="container content-md welcomeSection">
			<div class="row section1" style="text-align: center;">
				<div class="col-md-6" style="margin-bottom: 40px;" style="border:2px solid black; background: green;">
					...
					<a style="    border-radius: 5px;" href="aboutreg.php" class="btn-u btn-brd btn-brd-hover">Read
						More</a>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6 col-2xs-12">
							<div style="border-radius: 10px;" class="pricing-v9 hover-effect">
								...
								<a href="contreg.php"><input type="submit" class="allsub" style="margin-bottom: 15px;"
										value="Purchase"></a>
							</div>
						</div>
						<!-- /Pricing Item -->
				...
				<div class="row news-v1">
					<div class="col-md-4" style="margin-bottom: 40px;">
						<div class="news-v1-in">
							<img style="height: 22rem;" class="img-responsive" src="assets/img/logo/dog1.jpg" alt="">
							<h3><a href="blogreg.php">Common Diseases Found In Dogs & Cats</a></h3>
							...
							<ul class="list-inline news-v1-info">
								...
								<li><a href="blogreg.php" class="btn-u btn-brd btn-brd-hover blogButton">Read More</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="col-md-4" style="margin-bottom: 40px;">
						<div class="news-v1-in">
							...
							<h3><a href="blogreg.php">How to Manage Cats’ Scratching</a></h3>
	...
	" src="assets/img/logo/win.jpg" alt="">
							<h3><a href="blogreg.php">PREPARING FOR WINTER WITH PETS</a></h3>
					...
					width: 110px; margin-left:60px; border-radius:10px;" src="assets/img/logo/ph.png" alt=""></a>
						...
						<div class="col-md-3" style="margin-bottom: 40px;">
							...
							<ul class="list-unstyled link-list">
								...
								<li><a href="bookreg.php">Book Appointment</a><i class="fa fa-angle-right"></i>
								</li>
							</ul>
						</div>
						<!--/col-md-3-->
