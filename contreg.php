...
<head>
	<title> Contact Us | PET HELPER</title>
			...
			<div class="navbar mega-menu" role="navigation">
				<div class="container">
					...
					DOCTORS
								...
								<!-- Contact Us -->
								<li class="mega-menu-fullwidth">
									<a style=" color: white; background-color: #72c02c; text-decoration: underline; border-radius: 5px;"
										href="contreg.php">
										CONTACT US
									</a>
								</li>
		...
		<div class="container content">
			<div class="row " style="margin-bottom: 30px;">
				<div class="col-md-9" style="margin-bottom: 30px;">
					...
					<form action="contdata.php" method="post" class="sky-form sky-changes-3">
						<fieldset>
							<div class="row">
							...
							<section>
								...
								<label class="input">
									...
									<input type="text" required placeholder="Enter Your Subject(for e.g. Heading)"
							...
							<section>
								...
								<label class="input">
									...
									<input type="text" required placeholder="Enter Your Mobile Number " name="number"
										id="number">
								</label>
							</section>
							...
							<section>
								...
								<label class="textarea">
									...
									<textarea rows="4" required name="message" placeholder="Enter Your Messgae Here..."
										id="message"></textarea>
								</label>
							</section>
				...
				<div class="col-md-3" style="margin-top: 56px;">
					...
					<ul class="list-unstyled who" style="margin-bottom: 30px;">
						...
						<li><a href="#"><i class="fa fa-envelope"></i>pethelper15081947@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-phone"></i>97582 01843</a></li>
						<li><a href="#"><i class="fa fa-globe"></i>http://www.pethelper.com</a></li>
					</ul>
					...
					<ul class="list-unstyled " style="margin-bottom: 30px;">
						...
						<li><strong>Sunday:</strong> 9:00 AM to 16:00 PM.</li>
					</ul>
